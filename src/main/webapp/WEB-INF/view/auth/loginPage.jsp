                        ...
                        <form action="${authAction}" method="post" id="authForm">
                            ...
                            <feildset>
                                <div class="form-group">
                                    <input type="text"  data-title="Please use valid Email address" name="j_username" class="form-control" data-require="" placeholder="Email address" data-regex="email" id="SignInMail"/>
                                </div>
                                <div class="form-group">
                                    <input type="password"  data-minlength="6" data-title="Please enter valid password" data-require="" name="j_password" class="form-control" placeholder="Password" id="SignInPassword"/>
                                </div>
                                ...
                                <div class="form-group text-center">
                                    <button class="btn btn-primary" type="submit" onclick="return setVariablesForModal();">Sign In/ Sign Up</button>
                                </div>
                            </feildset>
                    ...
                    <form action="${createUserAction}"  id="userCreationForm" method="post">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="sumbit" class="btn btn-primary" onclick="return setVariablesToModal();">Yes</button>
                            </div>
                        </div>
                        <fieldset>
